...
from utils.entropy_cal import get_local_entropy_top_mask
    ...
    def compute_loss(self, batch):
        ...
        with torch.no_grad():
            with self.accelerator.autocast():
                ...
                if self.online_entropy_threshold_mask:
    ...
    def validate(self):
        ...
        with self.accelerator.autocast():
            for batch in self.val_dataloader:
                ...
                peak_correct_num = ((peak_preds == shift_labels)*shift_loss_mask).sum()
                ...
                adaptive_correct_num = ((adaptive_preds == shift_labels)*shift_loss_mask).sum()
                shift_exit_steps = model_output.exit_steps[..., :-1]+1
                exit_steps_num = shift_exit_steps[shift_loss_mask].sum()
