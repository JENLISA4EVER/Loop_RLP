...
def get_args():
    ...
    parser.add_argument("--output_dir", type=str, default="/share/home/sxjiang/myproject/self-learn/datasets/processed/omni_math/entropy_split")
...
if __name__ == "__main__":
    ...
    with torch.no_grad():
        with accelerator.autocast():
            for batch in dataloader:
                ...
                entropy_top_mask = get_local_entropy_top_mask(entropy, shift_loss_mask, top_ratio=args.entropy_threshold)
    ...
    with open(os.path.join(args.output_dir, f"train_{accelerator.process_index}.jsonl"), "w") as f:
